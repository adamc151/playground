...
const FormProvider = props => react__WEBPACK_IMPORTED_MODULE_0__.createElement(FormContext.Provider, {
...
function useController({
  ...
  const [value, setInputStateValue] = react__WEBPACK_IMPORTED_MODULE_0__.useState(field && field._f && !isUndefined(field._f.value) ? field._f.value : isUndefined(get(defaultValuesRef.current, name)) ? defaultValue : get(defaultValuesRef.current, name));
  const {
    onChange,
    onBlur,
    ref
...
const useFieldArray = ({
  ...
  const [fields, setFields] = react__WEBPACK_IMPORTED_MODULE_0__.useState(mapIds((get(fieldsRef.current, name) && isMountedRef.current ? get(getFieldsValues(fieldsRef), name) : get(fieldArrayDefaultValuesRef.current, getNodeParentName(name)) ? get(fieldArrayDefaultValuesRef.current, name) : get(defaultValuesRef.current, name)) || [], keyName));
...
function useForm({
  ...
  const shouldRenderBaseOnError = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(async (shouldSkipRender, name, error, fieldState, isValidFromResolver, isWatched) => {
    ...
    const isValid = readFormStateRef.current.isValid ? resolver ? isValidFromResolver : shouldRenderBaseOnValid() : false;
    ...
    if ((isWatched || (error ? !deepEqual(previousError, error) : previousError) || !isEmptyObject(fieldState) || formStateRef.current.isValid !== isValid) && !shouldSkipRender) {
      const updatedFormState = Object.assign(Object.assign(Object.assign({}, fieldState), resolver ? {
        isValid: !!isValid
      } : {}), {
        errors: formStateRef.current.errors,
        name
  ...
  const handleChange = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(async ({
    type,
    target,
    target: {
      value,
...
function useWatch(props) {
  ...
  const [value, updateValue] = react__WEBPACK_IMPORTED_MODULE_0__.useState(isUndefined(defaultValue) ? watchInternal(name) : defaultValue);
  react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
    watchInternal(name);
...
var App = function App() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_state_context__WEBPACK_IMPORTED_MODULE_1__.default.Provider, {
    value: {
      state: state,
      dispatch: dispatch
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_Input__WEBPACK_IMPORTED_MODULE_4__.default, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_Output__WEBPACK_IMPORTED_MODULE_3__.default, null));
};
...
function App() {
  ...
  return (
    ...
    }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, errors.example && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", null, "This field is required")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
      type: "submit"
    }))
  );
}
...
var Output = function Output() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, "Hi ", state.name, " from React! Welcome!");
};
...
react_dom__WEBPACK_IMPORTED_MODULE_1__.hydrate( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_App__WEBPACK_IMPORTED_MODULE_2__.default, null), document.getElementById("app"));
})();
